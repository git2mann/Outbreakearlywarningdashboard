  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200 shadow-sm">
        <div className="container mx-auto px-4 py-4 sm:py-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-gray-900">Outbreak Early Warning System</h1>
              <p className="text-gray-600 text-sm sm:text-base mt-1">Kenya Ministry of Health - Weekly Risk Assessment</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="container mx-auto px-4 py-6 space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-gray-900">Filter by Disease</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="flex flex-wrap gap-2">
              <Button
                ...
                className={diseaseFilter === 'all' ? 'bg-gray-900 hover:bg-gray-800' : ''}
              >
                All Risks
              </Button>
              <Button
                ...
                className={diseaseFilter === 'cholera' ? 'bg-blue-600 hover:bg-blue-700' : ''}
              >
                Cholera Only
              </Button>
              <Button
                ...
                className={diseaseFilter === 'malaria' ? 'bg-orange-600 hover:bg-orange-700' : ''}
              >
                Malaria Only
              </Button>
            </div>
                      ...
                      <div className="flex items-start justify-between gap-2 mb-2">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            <span className="bg-gray-900 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs">
                              {index + 1}
                            </span>
                            <span className="text-gray-900">{risk.name}</span>
                          </div>
                          <p className="text-gray-600 text-sm">{risk.county} County</p>
                        </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-gray-900">Risk Level Legend</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="flex flex-wrap gap-4">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-green-500 rounded"></div>
                <span className="text-gray-700">Low Risk (0.00 - 0.33)</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-yellow-500 rounded"></div>
                <span className="text-gray-700">Moderate Risk (0.34 - 0.66)</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-red-500 rounded"></div>
                <span className="text-gray-700">High Risk (0.67 - 1.00)</span>
              </div>
            </div>
          </CardContent>
        </Card>
